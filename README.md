...
- 최종 산출물로 Markdown/HTML/PDF 보고서와 JSONL 실행 로그를 남깁니다.

## Current Outputs
- Markdown 보고서: [`outputs/report.md`](./outputs/report.md)
- HTML 보고서: [`outputs/report.html`](./outputs/report.html)
...
- normalization / validator / review
  - `tests/test_normalization.py`
  - `tests/test_validation.py`
  - `tests/test_review_prompt.py`
- reporting / charting / PDF smoke
...
- `outputs`: 최종 Markdown/HTML/PDF 보고서
- `logs`: 실행 로그
...
- 제출 전 수동 시각 점검 항목은 [`docs/runbook.md`](./docs/runbook.md)의 `Manual Submission Checklist`를 기준으로 확인합니다.
