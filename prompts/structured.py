    ...
    return PromptBundle(
        ...
        instructions="\n\n".join(
            [
                ...
                "report_spec가 최종 제출 계약의 primary input이며, comparison_matrix, swot_matrix, scorecard는 compatibility-only 보조 입력으로만 사용한다.",
                ...
                "revision target이 필요하면 supervisor_synthesis, market_research, lges_analysis, catl_analysis, comparison 중 하나만 사용한다.",
            ]
        ),
        input_text=json.dumps(payload, ensure_ascii=False, indent=2),
    )
